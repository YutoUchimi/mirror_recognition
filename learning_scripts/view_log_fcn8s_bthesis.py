...
def main():
    ...
    fig01.set_title('train/segmentation_loss')
    ...
    fig02.set_title('train/regression_loss')
    ...
    # fig04.plot(iteration2epoch, train_depth_acc_001, label='d=1cm')
    fig04.plot(iteration2epoch, train_depth_acc_003, label='d=3cm')
    fig04.plot(iteration2epoch, train_depth_acc_010, label='d=10cm')
    fig04.plot(iteration2epoch, train_depth_acc_030, label='d=30cm')
    # fig04.plot(iteration2epoch, train_depth_acc_100, label='d=100cm')
    fig04.legend()
    fig04.set_title('train/depth_acc,d')
    ...
    fig10.set_title('validation/loss')
    ...
    fig11.set_title('validation/segmentation_loss')
    ...
    fig12.set_title('validation/regression_loss')
    ...
    fig13.set_title('validation/miou')
    ...
    # fig14.plot(epoch, val_depth_acc_001, label='d=1cm')
    fig14.plot(epoch, val_depth_acc_003, label='d=3cm')
    fig14.plot(epoch, val_depth_acc_010, label='d=10cm')
    fig14.plot(epoch, val_depth_acc_030, label='d=30cm')
    # fig14.plot(epoch, val_depth_acc_100, label='d=100cm')
    fig14.legend()
    fig14.set_title('validation/depth_acc,d')
