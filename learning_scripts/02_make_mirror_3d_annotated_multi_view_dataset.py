...
def main(src_dir, dst_dir, split):
    ...
    for i, stamp_dir in enumerate(sorted(os.listdir(raw_split_dir))):
        ...
        scene_id_file = osp.join(raw_split_dir, stamp_dir, 'scene_id.txt')
        base_offset_x_file = osp.join(
            raw_split_dir, stamp_dir, 'base_offset_x.txt')
        base_offset_y_file = osp.join(
            raw_split_dir, stamp_dir, 'base_offset_y.txt')
        head_offset_p_file = osp.join(
