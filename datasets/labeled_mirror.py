...
class LabeledMirrorWithDepthDataset(chainer.dataset.DatasetMixin):
    ...
    root_dir = osp.expanduser(
        '~/data/mvtk/mirror_recognition/labeled_mirror_with_depth_dataset')
    mean_bgr = np.array([104.00698793, 116.66876762, 122.67891434])
