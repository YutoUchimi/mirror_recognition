...
class FCN8sMirrorSegmentation(chainer.Chain):
    ...
    def __init__(self, n_class):
        ...
        super(FCN8sMirrorSegmentation, self).__init__()
    ...
    def __call__(self, bgr, gt=None):
        score, pool3, pool4, fc7 = self.segment(bgr)
        self.score = score
