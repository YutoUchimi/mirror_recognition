...
class FCNAtOnceConcatAtOnce(ConnectionBasedTransport):
    ...
    def _load_model(self):
        ...
        if model_name == 'FCN8sAtOnceConcatAtOnce':
...
if __name__ == '__main__':
    rospy.init_node('fcn_at_once_concat_at_once')
    FCNAtOnceConcatAtOnce()
    rospy.spin()
